...
class FacultyUploads extends Component {
    state = {
        dateset:{
          startdate:'',
          enddate:'',
        ...
        async componentDidMount() {
          ...
          const { data }=await http.get(`http://localhost:4000/faculty/${this.props.userid}`)
          console.log(data)
          const dateset={
            startdate:'',
            enddate:'',
      ...
      handleSubmit =async (e)=>{
          ...
          this.props.history.push('/faculty/result')
          }
          catch (err){
      ...
      render() { 
          return (
              ...
              <div className="panel-heading main-color-bg">
                <h2 className="panel-title dash-box"><span className="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Recent Uploads</h2>
              </div>
