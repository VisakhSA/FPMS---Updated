...
class Adminresetpw extends Component {
    ...
    handleSubmit =async (e)=>{
        ...
        if (errors) return;
        try{
            await http.post(`http://localhost:4000/admin/reset-password/${this.props.match.params.id}/${this.props.match.params.token}`,{password:this.state.account.password})
