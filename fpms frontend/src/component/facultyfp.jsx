...
class Facultyfp extends Component {
    state = {
        account : {
            username: ''
        },
    ...
    handleSubmit =async (e)=>{
        ...
        if (errors) return;
        try{
            await http.post('http://localhost:4000/faculty/forget-password',{email:this.state.account.username})
        ...
        return (  
            <div className="container">
                ...
                <div className="wrapper">
                    ...
                    <input id="username" name="username" type="text" className="form-control" value={this.state.account.username} onChange={this.handleChange} /> 
